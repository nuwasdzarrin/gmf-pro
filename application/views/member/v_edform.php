<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Edit Data Change No: <?php echo($edd->code_pla."-".$edd->numb);?></h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<form role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('member/EdData/updateform')?>">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="hidden" name="numb" value="<?php echo $edd->numb;?>">
								</div>
								<div class="form-group">
									<label>Ref_Man</label>
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<select class="form-control" name="ac_type" style="width: 200px">
