		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<form role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('DelData/upDel')?>">
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="desc" rows="5"><?php echo $edd->task_desc;?></textarea>
								</div>
								<div class="form-group">
									<label>Ref_Man</label>
